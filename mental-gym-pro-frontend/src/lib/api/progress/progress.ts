...
import { getJSON, get } from '../config';
...
const ACTUAL_USE_MOCK = FORCE_MOCK; 
console.log('🔍 USE_MOCK en progress.ts:', ACTUAL_USE_MOCK);
...
  console.log('🔍 USE_MOCK value:', ACTUAL_USE_MOCK);
  
  if (ACTUAL_USE_MOCK) {
